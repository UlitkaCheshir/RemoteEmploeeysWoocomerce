...
<header style="background: url(<?=$image?>) no-repeat center/cover" class="section" id="section0">
    <div class="header-wrapper">
        ...
        <nav class="menu-top">
            ...
            <a href="#section13" class="menu-top-link">Вакансии</a>
            <a href="#section2" class="menu-top-link">Условия работы</a>
            <a href="#about-sec" class="menu-top-link">О нас</a>
            <a href="#section-partners" class="menu-top-link">Работодатели</a>
